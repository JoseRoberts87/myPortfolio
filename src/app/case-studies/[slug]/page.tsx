...
export default async function CaseStudyPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      <Section padding="xl" background="subtle">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6">
            <Link
              href="/case-studies"
              className="text-accent hover:text-purple-300 flex items-center gap-2 text-sm"
            >
          ...
          <h2 className="text-2xl text-accent mb-6 font-medium">
            {caseStudy.subtitle}
          </h2>
      ...
      <Section padding="lg">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl font-bold text-foreground mb-6 text-center">Key Metrics</h3>
      ...
      <Section padding="lg" background="subtle">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl font-bold text-foreground mb-6 text-center">Technologies Used</h3>
      ...
      {caseStudy.relatedCaseStudies.length > 0 && (
        <Section padding="lg">
          <div className="max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-foreground mb-6">Related Case Studies</h3>
        ...
        <div className="prose dark:prose-invert prose-lg max-w-none mb-6">
          {section.content.map((paragraph, idx) => {
            ...
            if (paragraph.startsWith('**') && paragraph.includes('**:')) {
              ...
              return (
                <p key={idx} className="text-body mb-4">
            ...
            // Check if it's a bullet point (starts with •)
              ...
              return (
                <p key={idx} className="text-body mb-2 ml-4">
                  {paragraph}
                </p>
              );
            }
            ...
            // Regular paragraph
              ...
              return (
                <p key={idx} className="text-body mb-4 leading-relaxed">
                  {paragraph}
                </p>
              );
            }
          ...
          <Card variant="bordered" padding="lg" className="mb-6">
            ...
            <ul className="space-y-2">
              {section.highlights.map((highlight, idx) => (
                <li key={idx} className="text-body flex items-start gap-3">
