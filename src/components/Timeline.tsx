...
const experienceData: TimelineItem[] = [
  {
    ...
    description: 'Key architect and builder of robust, scalable data pipelines using Databricks and AWS, working directly with clients to understand and deliver on their AI and data needs.',
    highlights: [
