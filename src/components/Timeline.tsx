...
const experienceData: TimelineItem[] = [
  {
    ...
    description: 'Led teams of engineers emphasizing product ownership and scalable solutions for IoT product usage and services.',
    highlights: [
      'Consulted in multiple efforts to design and build scalable backends for IoT products',
      'Engineered event-driven scalable backends for advanced marketing, increasing sales profits 15% in 3 months',
      'Led cross-functional collaboration with product/design teams for social media platform development',
      'Improved build automation tools using infrastructure as code, reducing development lifecycles',
      'Developed full-stack AI-first app for creative marketing using StabilityAI and OpenAI, increasing profits 12% in one month',
    ],
    type: 'experience',
  },
  {
