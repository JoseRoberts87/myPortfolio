...
export function PipelineMetricsDashboard({ metrics, loading }: PipelineMetricsDashboardProps) {
  if (loading) {
    return (
      <Card variant="elevated" padding="lg">
        ...
        <div className="text-center py-8 text-slate-500 dark:text-gray-400">Loading metrics...</div>
      </Card>
    );
  }
  ...
  if (!metrics) {
    return (
      <Card variant="elevated" padding="lg">
        <h3 className="text-xl font-semibold mb-6">Pipeline Metrics (Last 7 Days)</h3>
        <div className="text-center py-8 text-slate-500 dark:text-gray-400">Unable to load metrics</div>
      </Card>
    );
  }
    ...
    <Card variant="elevated" padding="lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="text-center">
          ...
          <div className="text-sm text-slate-500 dark:text-gray-400 mt-1">Total Runs</div>
        ...
        <div className="text-center">
          ...
          <div className="text-sm text-slate-500 dark:text-gray-400 mt-1">Success Rate</div>
        ...
        <div className="text-center">
          ...
          <div className="text-sm text-slate-500 dark:text-gray-400 mt-1">Avg Duration</div>
          <div className="text-xs text-slate-400 dark:text-gray-500 mt-1">Per pipeline run</div>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="text-sm text-slate-500 dark:text-gray-400 mt-1">Records Processed</div>
          <div className="text-xs text-slate-400 dark:text-gray-500 mt-1">
      ...
      {metrics.last_run && (
        <div className="mt-6 pt-6 border-t border-slate-200 dark:border-gray-700">
          <h4 className="text-sm font-semibold text-slate-500 dark:text-gray-400 mb-3">Latest Pipeline Run</h4>
          <div className="bg-slate-100 dark:bg-gray-800/50 rounded-lg p-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div>
                <span className="text-slate-500 dark:text-gray-400">Records:</span>
                <span className="ml-2 text-slate-900 dark:text-white">
